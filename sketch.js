...
createCanvas(800,800);  
 ...
 ball.scale = 0.09;
 ball.debug=true;
 cup = createSprite(760,770,10,80);//the cup at the end
 cup.addImage(cupImg);
 cup.scale = 0.09;
 ...
 cardboard16 = createSprite(700,620,40,220);
 ...
 cardboard23 = createSprite(300,780,260,40)
 cardboard24 = createSprite(484,20,40,80)   
 cardboard25 = createSprite(510,700,220,40)
